package com.yash.training.assignment.oops.Program1;

/**
*   Create a class Person with following member and setter getter for them.
	Pid, pname, paddress,dob all are private. Now Person class will be
	inherit by the Employee class will have following fields salary,
	date_of_joining, base_location, deptobj, contactno, emailid. Department
	class will have following member, deptid, and dname. Customer class
	also inherit the Person class, it also has following fields: -
	date_of_registration, delivery_address, contactno, email_id. Setter and
	getter methods for all class variables should be declared.
	...
	as they are protected. Create array of object of department class and while
	creating the object of the Employee class we will pass object of that
